...
<div class="container mt-5">
    <h2 class="mb-4 text-center"><img src="../img/crear_ejercicio.png" alt="Crear ejercicio" style="height:60px;vertical-align:middle;margin-right:7px;">Crear Nuevo Ejercicio</h2>
